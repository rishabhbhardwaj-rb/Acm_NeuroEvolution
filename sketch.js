...
function draw() {
  ...
  // Update DOM Elements
  if(tempHighScore>=25){
    highScoreSpan.html(Math.floor((tempHighScore-25)/75));
    allTimeHighScoreSpan.html(Math.floor((highScore-25)/75));
  }
